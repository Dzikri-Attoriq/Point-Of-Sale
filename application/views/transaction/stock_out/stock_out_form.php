                    ...
                    <div class="col-md-12">
                        <form action="<?= site_url('stock/process') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="detail" id="detail" class="form-control" placeholder="Rusak / kadaluwarsa / etc" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" name="out_add" value="out_add" class="btn btn-success btn-flat">
